    ...
    >
      <div className="space-y-4">
        <div>
          ...
          <input
            className="mt-2 block w-full rounded-lg border border-gray-600 bg-gray-700 p-2.5 text-sm text-white placeholder-gray-400 focus:ring-emerald-500 focus:border-emerald-500"
            id="voucher"
            type="text"
